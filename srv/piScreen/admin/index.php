			...
			<div class='col-sm-12 col-lg-6 mb-4'>
				<div class='card p-3 shadow'>
					...
					<p>
						...
						<i class='bi bi-aspect-ratio'> </i><span lang-data='display-resolution'>Display Auflösung</span>: <span id='displayResolution'>???</span><br>
			...
			<div class='col-sm-12 col-lg-6 mb-4'>
				<div class='card p-3 shadow'>
					...
					<div>
						...
						<button id="startupTriggerExecuteButton" class="disableOnDisconnect executeButton btn btn-outline-warning mt-2" onclick='executeStartupTrigger();'><i class='bi bi-play pe-2'></i><span id='executestartupTriggerSpinner' class='spinner-border spinner-border-sm' role='status' hidden='true'></span><span lang-data="execute">Ausführen</span></button>
					</div>
				</div>
			</div>
						...
						<div class="carousel-inner">
							<div class="carousel-item active">
								...
								<div>
									...
									<button id='lastCronButton' class='disableOnDisconnect executeButton btn btn-outline-warning mt-2 px-2' onclick="sendHTTPRequest('GET', 'cmd.php?id=22', true);"><i class='bi bi-play pe-2'></i><span lang-data='lastcron'>Letzter Eintrag ausführen</span></button>
								</div>
							</div>
						...
						<tr>
							...
							<td style="width: 70%;" class="border border-primary p-3">
								...
								<div class="d-inline" style="float: right;">
									<button id="fileExplorerExecuteFile" class="btn btn-sm btn-outline-warning executeButton m-1" onclick='executeFileExplorerFile();' disabled><i class='bi bi-play pe-2'></i><span id='fileExplorerExecuteFileSpinner' class='spinner-border spinner-border-sm' role='status' hidden='true'></span><span lang-data="execute">Ausführen</span></button>
