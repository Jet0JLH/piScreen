		...
		<div id='masonry' class='row' data-masonry='{&quot;percentPosition&quot;: true }'>
			...
			<div class='col-sm-12 col-lg-6 mb-4'>
				<div class='card p-3 shadow'>
					...
					<div class='row'>
						<div class='col-4'>
							<button id='reloadBtn' type='button' class='disableOnDisconnect btn btn-primary w-100 my-1'><i class='bi bi-arrow-clockwise btn-icon-xxl'></i><br><span lang-data='restart-browser'>Browser neu starten</span></button>
						</div>
						<div class='col-4'>
							<button id='restartBtn' type='button' class='disableOnDisconnect btn btn-warning w-100 my-1'><i class='bi bi-bootstrap-reboot btn-icon-xxl'></i><br><span lang-data='restart-device'>Neustarten</span></button>
						</div>
						<div class='col-4'>
							<button id='shutdownBtn' type='button' class='disableOnDisconnect btn btn-danger w-100 my-1'><i class='bi bi-power btn-icon-xxl'></i><br><span lang-data='shutdown-device'>Ausschalten</span></button>
						</div>
					</div>
					<div class='row'>
						<div class='col-4'>
							<button id='displayOnBtn' type='button' class='disableOnDisconnect btn btn-success w-100 my-1'><span id='spinnerDisplayOn' class='spinner-border spinner-border-sm' role='status' hidden=''></span> <i class='bi bi-display btn-icon-xxl'></i><br><span lang-data='display-on'>Display an</span></button>
						</div>
						<div class='col-4'>
							<button id='displayStandbyBtn' type='button' class='disableOnDisconnect btn btn-danger w-100 my-1'><span id='spinnerDisplayStandby' class='spinner-border spinner-border-sm' role='status' hidden=''></span> <i class='bi bi-display btn-icon-xxl'></i><br><span lang-data='display-off'>Display Standby</span></button>
						</div>
					</div>
				</div>
			</div>
			<div class='col-sm-12 col-lg-6 mb-4'>
				<div class='card p-3 shadow'>
					...
					<hr>
					<div id='info-footer'>
					<button id='versionInfoBtn' class='disableOnDisconnect btn btn-primary' lang-data='about-info'>piScreen Info</button>
					</div>
				</div>
			</div>
			<div class='col-sm-12 col-lg-6 mb-4'>
								...
								<div class="accordion-body p-0">
									<table style='width: 100%;'>
										<tr>
											...
											<td style='width: 8%;'>
												<button id='settingsButtonSaveHostname' type='button' class='disableOnDisconnect btn btn-success ms-3 mb-3' onclick='setHostname("settingsHostnameInput");'><i class='bi bi-check2'></i></button>
											</td>
										</tr>
										<tr>
											<td>
											...
											<td style='width: 8%;'>
												<button id='settingsButtonSaveDisplayProtocol' type='button' class='disableOnDisconnect btn btn-success ms-3 mb-3' onclick='setDisplayProtocol();'><i class='bi bi-check2'></i></button>
											</td>
										</tr>
										<tr>
											<td>
											...
											<td style='width: 8%;'>
												<button id='settingsButtonSaveDisplayOrientation' type='button' class='disableOnDisconnect btn btn-success ms-3 mb-3' onclick='setDisplayOrientation();'><i class='bi bi-check2'></i></button>
											</td>
										</tr>
									</table>
									<button type='button' id='showLoginSettings' class='disableOnDisconnect btn btn-outline-primary' data-bs-toggle="collapse" data-bs-target="#collapseLoginSettings"><i class='bi bi-pencil-square pe-2'></i><span lang-data="edit-weblogin">Weblogindaten bearbeiten</span></button>
								</div>
							</div>
						</div>
						<div class="accordion-item" style='background-color: transparent;'>
							<div id="collapseLoginSettings" class="accordion-collapse collapse" data-bs-parent="#settingsAccordion">
								<div class="accordion-body p-0">
									...
									<button type='button' id='saveAndShowMainSettings' class='disableOnDisconnect btn btn-outline-success' data-bs-toggle="collapse" data-bs-target="#collapseMainSettings" onclick='setWebLoginAndPassword();'><i class='bi bi-save pe-2'></i><span lang-data="save-weblogin">Weblogindaten speichern</span></button>
									<button type='button' id='cancelAndShowMainSettings' class='disableOnDisconnect btn btn-outline-primary' data-bs-toggle="collapse" data-bs-target="#collapseMainSettings"><i class='bi bi-arrow-left pe-2'></i><span lang-data="back">Zurück</span></button>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="accordion-item" style='background-color: transparent;'>
							<div id="collapseTwo" class="accordion-collapse collapse show" data-bs-parent="#scheduleAccordion">
								<div class="accordion-body p-0">
									...
									<button id='showEvents' class='disableOnDisconnect btn btn-outline-primary' data-bs-toggle="collapse" data-bs-target="#collapseOne" hidden>Events bearbeiten</button>
								</div>
							</div>
						</div>
						...
						<div class="accordion-item" style='background-color: transparent;'>
							...
							<h3 class='pb-2 accordion-header' id="headingOne">Events bearbeiten</h3>
								<div class="accordion-body p-0">
									...
									<button id='showSchedule' class='disableOnDisconnect btn btn-outline-primary' data-bs-toggle="collapse" data-bs-target="#collapseTwo">Events speichern</button>
								</div>
							</div>
						</div>
					</div>
